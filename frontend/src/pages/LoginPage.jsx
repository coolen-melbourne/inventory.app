  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (login.fulfilled.match(resultAction)) {
        const user = resultAction.payload.user; // backenddan kelgan user
        localStorage.setItem("token", resultAction.payload.token); // token saqlash
        ...
        <div className="max-w-md w-full">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center mb-6">
              ...
              <label htmlFor="terms" className="text-gray-600 text-sm">Agree on terms and conditions</label>
            </div>
